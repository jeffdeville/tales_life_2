    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      <div class="max-w-xl mx-auto">
        <div class="text-center mb-8">
          <h1 class="text-3xl font-bold mb-3" style="font-family: var(--tl-font-serif);">
            Start a New Interview
          </h1>
          <p class="text-base-content/70 leading-relaxed">
            Capture someone's life story, one question at a time.
            There are no wrong answers &mdash; every memory matters.
          </p>
        </div>

        <div class="bg-base-100 rounded-xl p-6 sm:p-8 shadow-sm border border-base-300/50">
          <.form for={@form} id="new-interview-form" phx-change="validate" phx-submit="save">
            ...
            <div class="mb-6">
              ...
              <div class="space-y-3">
                <label
                  :for={era <- @eras}
                  class="flex items-start gap-3 p-4 rounded-lg border border-base-300/60 cursor-pointer hover:bg-base-200/50 transition-colors"
                >
                  <input
                    type="checkbox"
            ...
            <div class="bg-base-200/40 rounded-lg p-4 mb-6 border border-base-300/30">
              <p class="text-sm text-base-content/70 leading-relaxed">
                ...
                naturally &mdash; you can skip any question and come back to it later.
              </p>
            </div>
