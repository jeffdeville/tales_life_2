defmodule TalesLife2Web.UserAuthTest do
  use TalesLife2Web.ConnCase, async: true

  alias TalesLife2.Accounts
  alias TalesLife2.Accounts.Scope
  alias TalesLife2Web.UserAuth

  import TalesLife2.AccountsFixtures

  @remember_me_cookie "_tales_life2_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TalesLife2Web.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
